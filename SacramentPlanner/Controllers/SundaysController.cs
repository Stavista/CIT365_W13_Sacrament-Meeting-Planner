...
namespace SacramentPlanner.Controllers
{
    public class SundaysController : Controller
    {
        ...
        {
            return View(await _context.Sunday.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Date,Conductor,OpeningHymn,ClosingHymn,SacramentHymn,IntermediateSong,OpeningPrayer,ClosingPrayer")] Sunday sunday)
        {
